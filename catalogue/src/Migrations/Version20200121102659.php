 ...
 */
final class Version20200121102659 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE products ADD date_update VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE products_images (products_id INT NOT NULL, images_id INT NOT NULL, INDEX IDX_662C35406C8A81A9 (products_id), INDEX IDX_662C3540D44F05E5 (images_id), PRIMARY KEY(products_id, images_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE products DROP date_update');
    }
}
